/**
 * BETORACL PRO — Client Supabase
 * Intégration frontend : Auth, Analyses Oracle, Paiements, Bankroll
 * Inclure AVANT betoracl-logos.js dans chaque page HTML
 *
 * Usage :
 *   <script src="https://cdn.jsdelivr.net/npm/@supabase/supabase-js@2/dist/umd/supabase.min.js"></script>
 *   <script src="../assets/js/betoracl-client.js"></script>
 */
...
(function () {
  ...
  if (!db) {
    console.warn("[Betoracl] Supabase SDK non chargé — mode démo actif");
  }
  ...
  function getDemoUser() {
    return { id: "demo-user", email: "demo@betoracl.pro" };
  }
  function getDemoProfile() {
    return {
      id: "demo-user", email: "demo@betoracl.pro", full_name: "Parieur Pro",
  ...
  // EXPORT GLOBAL
  // ════════════════════════════════════════════════════
  window.BetOraclDB = { Auth, Oracle, Payments, Bankroll, Notifications, db };
